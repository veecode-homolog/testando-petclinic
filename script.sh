...
while true; do
    ...
    curl -k "https://rest.homolog-minimal-otlp.vkpr.platform.vee.codes/testando-petclinic-k8s/info"

    echo \n

    curl -k "https://rest.homolog-minimal-otlp.vkpr.platform.vee.codes/testando-petclinic-obs/customer"
